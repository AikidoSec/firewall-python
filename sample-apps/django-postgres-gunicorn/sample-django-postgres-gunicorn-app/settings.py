"""
Django settings for sample-django-postgres-gunicorn-app project.
...
ROOT_URLCONF = 'sample-django-postgres-gunicorn-app.urls'
...
WSGI_APPLICATION = 'sample-django-postgres-gunicorn-app.wsgi.application'
