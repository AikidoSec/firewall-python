"""
Django settings for sample-django-mysql-gunicorn-app project.
...
DATABASES = {
    'default': {
        ...
        'HOST': config('DB_HOST', 'host.docker.internal'),  # Use 'db' as default from .env
...
WSGI_APPLICATION = 'sample-django-mysql-gunicorn-app.wsgi.application'
