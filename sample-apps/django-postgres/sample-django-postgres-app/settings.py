"""
Django settings for sample-django-postgres-app project.
...
ROOT_URLCONF = 'sample-django-postgres-app.urls'
...
WSGI_APPLICATION = 'sample-django-postgres-app.wsgi.application'
