"""
Based on https://github.com/mpetazzoni/sseclient
Licensed under the Apache License, Version 2.0
Copyright Maxime Petazzoni <maxime.petazzoni@bulix.org>
...
class SSEParser:
    """Implementation of a SSE parser.
    ...
    def __init__(self, event_source, char_enc="utf-8"):
        """Initialize the SSE parser over an existing, ready to consume
        event source.
...
class Event:
    ...
    def __init__(self, event_id=None, event="message", data="", retry=None):
        self.id = event_id
        self.event = event
        self.data = data
        self.retry = retry
