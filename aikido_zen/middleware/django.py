...
class AikidoDjangoMiddleware:
    ...
    def __init__(self, get_response):
        ...
        try:
            ...
            logger.warning("django.http import not working, aikido rate-limiting middleware not running.")
    ...
    def __call__(self, request):
        ...
        if result["type"] == "ratelimited":
            ...
            return self.HttpResponse("You are blocked by Zen.", content_type="text/plain", status=403)
